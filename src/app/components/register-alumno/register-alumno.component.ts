...
export class RegisterAlumnoComponent implements OnInit {
  ...
  registrarAlumno(){
    this.serverAlumnoService.insertarAlumno(this.alumnos.id_alumno,this.alumnos.nick, this.alumnos.fname, this.alumnos.lname, this.alumnos.mail, this.alumnos.year, this.alumnos.pssw, this.alumnos.psswConf).subscribe(
